...
COMMENT ON COLUMN partners.hide_branding     IS 'Hide the SiteLaunch footer on client-facing pages (paid+ only)';
COMMENT ON COLUMN partners.custom_footer_text IS 'Custom footer text replacing "SiteLaunch. The Cosmic Curator."';
