    ...
    <main className="min-h-screen flex flex-col selection:bg-primary/30">
      ...
      <section className="relative pt-36 md:pt-44 pb-24 md:pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 text-white">
          ...
          <h1 className="animate-fade-up delay-1 text-4xl md:text-5xl lg:text-6xl font-headline font-extrabold tracking-tight mb-8 leading-[1.1] text-white hero-text-glow">
            Your Agency&apos;s
            <br />
            <span className="gradient-text-hero">Command Center.</span>
          </h1>

          <p className="animate-fade-up delay-2 max-w-2xl mx-auto text-lg md:text-xl text-white/70 font-body mb-12 leading-relaxed hero-text-glow">
